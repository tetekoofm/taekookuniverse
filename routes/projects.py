...
def fan_letters():
    ...
    return render_template("09.fanletters.html", fan_letters=pagination.items, pagination=pagination, endpoint="projects.fan_letters", song_file=song_file, song_name=song_name)