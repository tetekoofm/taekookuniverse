document.addEventListener("DOMContentLoaded",()=>{
    ...
    function showRecipe(recipe){
        ...
        const images=(recipe.image || "").split("<br>").filter(Boolean);
        ...
        const hasIngredientSections=ingredientLines.some(line=>line.trim().endsWith(":"));
        ...
        recipeDetails.innerHTML=`
            ...
            ${images.length ?
            `
            <div class="recipe-image-gallery ${images.length===1?"single-image":""}">
                ${images.map(img=>`
            ...
            <div class="recipe-columns">
                ...
                <div class="recipe-section">
                    ...
                    <p class="ingredient-note">
                        * Estimated measurements based on Jungkook's livestream.
                    </p>
